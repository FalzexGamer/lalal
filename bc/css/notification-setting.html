...
<!-- Mirrored from askbootstrap.com/preview/eatsome/notification-setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 10:13:02 GMT -->
<head>
      <meta charset="UTF-8">
      <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <link rel="icon" href="img/logo.png" type="image/png">
      <title>Eatsome - Restaurant & Food Delivery Mobile Template</title>
      <!-- Bootstrap Css -->
   ...
   <body class="bg-light">
      ...
      <div>
         <div class="bg-white p-3 mb-2 shadow-sm">
            <div class="d-flex justify-content-between align-items-center">
               <div>
                  ...
                  <p class="text-muted m-0">Tap to enable notification</p>
               </div>
               <div>
                  <div class="form-check form-switch h5">
                     <input class="form-check-input bg-danger border-0" type="checkbox" role="switch"
                        checked>
                  </div>
               </div>
            </div>
         ...
         <div class="bg-white p-3 mb-2 shadow-sm">
            <div class="d-flex justify-content-between align-items-start">
               <div>
                  <h4>Enable all</h4>
                  <p class="text-muted m-0">Activate all notification</p>
               </div>
               <div class="form-check form-switch h5">
                  <input class="form-check-input bg-danger border-0" type="checkbox" role="switch"
                     checked>
         ...
         <div class="bg-white p-3 mb-2 shadow-sm">
            <div class="mb-4">
               <h4>Newsletters</h4>
               <p class="text-muted m-0">Receive newsletter to stay up-to date with whats brewing in food industry</p>
            </div>
            <div class="d-flex justify-content-between">
               <div class="fs-5"><i class="bi bi-envelope-fill me-2"></i>&nbsp;Email</div>
               <div class="form-check form-switch h5">
                  <input class="form-check-input bg-danger border-0" type="checkbox" role="switch"
                     checked>
               </div>
         ...
         <div class="bg-white p-3 mb-2 shadow-sm">
            <div class="mb-4">
               ...
               <p class="text-muted m-0">Receive updates about coupons, promotions and money saving offers</p>
            </div>
            <div class="d-flex justify-content-between">
               <div class="fs-5"><i class="bi bi-envelope-fill me-2"></i>&nbsp;Email</div>
               <div class="form-check form-switch h5">
            ...
            <hr>
            <div class="d-flex justify-content-between">
               <div class="fs-5"><i class="bi bi-bell-fill me-2"></i>&nbsp;Push</div>
               <div class="form-check form-switch h5">
                  <input class="form-check-input bg-danger border-0" type="checkbox" role="switch"
                     checked>
               </div>
         ...
         <div class="bg-white p-3 mb-2 shadow-sm">
            <div class="mb-4">
               ...
               <p class="text-muted m-0">Get notified when someone follows your profile, or when you get likes and comments
      ...
      <div class="fixed-bottom p-3">
         <div class="d-grid">
            <a href="search-list.html" class="btn btn-danger btn-lg">Save changes</a>
         </div>
      </div>
      <!-- sidebar -->
      <nav id="main-nav">
      ...
      <script src="vender/jquery/jquery.min.js" type="ee24bb2ec02614ab44d426bb-text/javascript"></script>
      <script src="vender/bootstrap/js/bootstrap.bundle.min.js" type="ee24bb2ec02614ab44d426bb-text/javascript"></script>
      <!-- slick Slider JS-->
      <script src="vender/slick/slick/slick.min.js" type="ee24bb2ec02614ab44d426bb-text/javascript"></script>
      <!-- Sidebar JS-->
      <script src="vender/sidebar/hc-offcanvas-nav.js" type="ee24bb2ec02614ab44d426bb-text/javascript"></script>
      <!-- Javascript -->
      <script src="js/custom.js" type="ee24bb2ec02614ab44d426bb-text/javascript"></script>
   <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="ee24bb2ec02614ab44d426bb-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8ee3bd487f297703","version":"2024.10.5","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}' crossorigin="anonymous"></script>
</body>
