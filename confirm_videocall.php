   ...
   <body>
      <div class="bg-white shadow-sm p-3">
         <div class="d-flex align-items-center">
            <div class="gap-3 d-flex align-items-center">
               ...
               <h3 class="fw-bold m-0">Schedule Video Call</h3>
            </div>
      ...
      <div class="my-5">
         <div class="text-center">
            ...
            <div class="h1 text-success mb-1">Your schedule date for video call appointment successfully submitted, </div>
            <div class="fs-5">Our team will contact you as soon as posible</div>
         </div>
      </div>
      <!-- buttons -->
      <div class="d-grid fixed-bottom gap-2 p-3">
         
		  <a href="video_call.php" class="btn btn-success btn-lg"><i class="fa-solid fa-caret-left"></i> Schedule Video Call</a>
         <a href="index.php" class="btn btn-success btn-lg"><i class="fa-solid fa-home"></i> Home</a>
      </div>
      <!-- sidebar -->
      <nav id="main-nav">
         <ul class="second-nav">
