...
<head>
    ...
    <style>
        ...
        .product-card-luxury:hover::after {
            opacity: 1;
        }
...
<body>
    <div class="luxury-container">
        ...
        <div class="product-grid-luxury">
            ...
            ?>
            <div class="product-card-luxury animate-fade-in-up" onclick="openProductDetails(<?php echo $row['recno']; ?>)">
                ...
                <div class="product-info-luxury">
                    ...
                    <div class="product-price-luxury">
                        RM <?php echo number_format($row['berat']*$harganew+ $row['upah'], 2); ?>
                    </div>
                    <button class="add-to-cart-btn" onclick="event.stopPropagation(); addToCart(<?php echo $row['recno']; ?>)">
    ...
    <script>
        ...
        function openProductDetails(productId) {
            ...
            window.location.href = `product-details-luxury.php?id=${productId}`;
        }
