...
<head>
   ...
   <body>
      ...
      <div class="bg-white shadow-sm p-3">
         <div class="d-flex align-items-center">
            <a href="index.php"><div class="gap-3 d-flex align-items-center">
              ...
              <i class="fa-solid fa-arrow-left"></i> <h3 class="fw-bold m-0">Redeem</h3>
            </div></a>
      ...
      <div class="bg-light p-3">
         <h5 class="m-0">Available For Redemption</h5>
      </div>
      <div class="p-3">
		  
		  <?php
							
$query=mysqli_query($conn,"select * from redeem ");
		...
		$tarikh_valid = $res['tarikh_valid'];
         ...
         <div>
            ...
            <div class="d-flex justify-content-between pb-3 align-items-center">
               <div class="text-uppercase fw-bold border border-danger text-danger rounded px-2 py-1 h5 m-0"><?php echo $no_redeem; ?></div>
               <div class="text-uppercase fw-bold border border-danger text-danger rounded px-2 py-1 h5 m-0">Point Need : <?php echo $point; ?></div>
            </div>
