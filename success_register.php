...
<head>
      ...
      <title>Nasi Ayam Warisan Apps</title>
      <!-- Bootstrap Css -->
   ...
   <body>
      <div class="bg-white shadow-sm p-3">
         <div class="d-flex align-items-center">
            <div class="gap-3 d-flex align-items-center">
               ...
               <h3 class="fw-bold m-0">Register Membership Account</h3>
            </div>
      ...
      <div class="my-5">
         <div class="text-center">
			  <div class="mb-3 px-5"><img src="icon/qrscan.png" class="img-fluid px-5" alt="#"></div>
            <br><div class="mb-3 px-5"><img src="img/green-tick.png" width="50" alt="#"></div>
            <div class="h1 text-success mb-1">Your registration success, Now you can login to claim discount and free drinks !</div>
      ...
      <div class="d-grid fixed-bottom gap-2 p-3">
         ...
         <a href="sign_in.php" class="btn btn-danger btn-lg">Sign In Now</a>
      </div>
      <!-- sidebar -->
      <nav id="main-nav">
         <ul class="second-nav">
