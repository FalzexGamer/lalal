...
<head>
   ...
   <body>
      ...
      <div class="bg-white shadow-sm p-3">
         <div class="d-flex align-items-center">
            <a href="index.php"><div class="gap-3 d-flex align-items-center">
              ...
              <i class="fa-solid fa-arrow-left"></i> <h3 class="fw-bold m-0">Voucher Discount</h3>
            </div></a>
      ...
      <div class="bg-light p-3">
         <h5 class="m-0">Available Voucher</h5>
      </div>
      <div class="p-3">
		  
		  <?php
							
$query=mysqli_query($conn,"select * from voucher where nofon='$nofon' ");
while($res=mysqli_fetch_array($query))
{
			$nofon = $res['nofon'];
	$novoucher = $res['novoucher'];
	$novoucher = $res['novoucher'];
		$detail = $res['detail'];
	$jumlah = $res['jumlah'];
		$tarikh_valid = $res['tarikh_valid'];
			?>
         ...
         <div>
            ...
            <p class="text-muted">Valid on <?php echo $tarikh_valid; ?>.&nbsp;</p>
			 <p class="text-muted">Discount RM <?php echo $jumlah; ?></p>
            <div class="d-flex justify-content-between pb-3 align-items-center">
               <div class="text-uppercase fw-bold border border-danger text-danger rounded px-2 py-1 h5 m-0"><?php echo $novoucher; ?></div>
               <div><a href="offers.html" class="text-decoration-none text-danger"></a></div>
            </div>
   ...
   <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="f01b1485aae253f2ed189d8b-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8ee3bd44df3a7703","version":"2024.10.5","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}' crossorigin="anonymous"></script>
</body>
